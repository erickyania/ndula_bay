        ...
        <div className="grid max-w-screen-xl px-4 py-8 mx-suto  lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
          <div className="mr-auto place-self-center lg:col-span-7">
            <h1 className="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl">
              Best of Kenya's shoe Fashion Industry.
            </h1>
            <p className="max-w-7xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl">
              Welcome to Ndulabay shop. Products made in Kenya by Kenyans to the
              World
            </p>
                          ...
                          <div className="mt-3">
                            ...
                            <p className="mt-1 text-sm text-gray-800">
                              ...
                              <span className="text-red-700">{`(-
                                ...
                                ${productItem.priceDrop}%) Off`}</span>
                            </p>
                          </div>
                        </li>
                      ))
